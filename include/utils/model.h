...
class Model
{
    ...
    void loadModelFile(const char* modelPath)
    {
        ...
        const aiScene* scene = importer.ReadFile(modelPath, aiProcess_Triangulate | aiProcess_JoinIdenticalVertices | aiProcess_CalcTangentSpace); // 0 to avoid post-processing operations?
